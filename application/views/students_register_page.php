				 ...
				 <form method="post" role="form" id="form_register">
                    ...
                    <div class="form-steps">
                        <div class="step current" id="step-1">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="dob" id="dob" placeholder="Date of Birth (DD/MM/YYYY)" data-mask="date" autocomplete="off" /> </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="step" id="step-2">
                            ...
                            <div class="input-group">
                                    <div class="input-group-addon"> <i class="entypo-flow-branch"></i> </div>
                                    <select name="semester" id="semester" title="Please select a semester" data-first-option="false" class="selectboxit">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="admnno" id="admnno" placeholder="College Admission Number" data-mask="decimal" autocomplete="off" /> </div>
                            </div>
                             <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"> <i class="entypo-leaf"></i> </div>
                                    <input type="text" class="form-control" name="regno" id="regno" placeholder="University Register Number" data-mask="decimal" autocomplete="off" /> </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"> <i class="entypo-info"></i> </div>
                                    <input type="text" class="form-control" name="rollno" id="rollno" placeholder="Class Roll Number" data-mask="decimal" autocomplete="off" /> </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"> <i class="entypo-calendar"></i> </div>
                            ...
                            <div class="form-group">
                                <button type="button" data-step="step-3" class="btn btn-primary btn-block btn-login" > <i class="entypo-right-open-mini"></i> Next Step
                                </button>
                            </div>
                        	<div class="form-group">
                                Step 2 of 3
