            ...
            <div class="sidebar-menu-inner">
                <header class="logo-env">
                    ...
                    <div class="sidebar-collapse">
                        ...
                        <ul id="main-menu" class="main-menu">
                            ...
                            <!-- <li class="<?php// if($current=="timeline") echo "active"; ?>"> 
                                <a href="<?php //echo $admin_url; ?>timeline/">
                                    <i class="entypo-feather"></i>
                                    <span class="title">Timeline</span>
                                </a>

                            </li> -->
                            <li class="<?php if($current=="search") echo "active"; ?>"> 
                                <a href="<?php echo $admin_url; ?>search/" >
                                    <i class="entypo-search"></i>
                                    <span class="title">Search</span>
                                </a> 
                            </li>
                            <li class="<?php if($current=="verify") echo "active"; ?>"> 
                                ...
                                <ul>
                                    <li class="<?php if($current=="verify") echo "active"; ?>"> 
                                        <a href="<?php echo $admin_url; ?>">
                                            <span class="title">Verify Accounts</span>
                                        </a> 

                                        <ul>
                                            <li class="<?php if($current=="verify" and $sub=="alumni") echo "active"; ?>"> 
                                            <a href="<?php echo $admin_url; ?>verify/alumni/">
                                                    <span class="title">Verify Alumni</span>
                                                </a> 
                                            </li>
                                            <li class="<?php if($current=="verify" and $sub=="faculty") echo "active"; ?>"> 
                                                <a href="<?php echo $admin_url; ?>verify/faculty/">
                                                    <span class="title">Verify Faculty</span>
                                                </a> 
                                            </li>
                                            <li class="<?php if($current=="verify" and $sub=="student") echo "active"; ?>">
                                               <a href="<?php echo $admin_url; ?>verify/student/">
                                                   <span class="title">Verify Student</span>
                                               </a> 
                                           </li>
                                   ...
                                   <li> 
                                    <a href="<?php echo $admin_url; ?>">
                                        <span class="title">Revoke Access</span>
                                    </a> 
                                </li>
                            </ul>
                        </li>
                ...
                <!-- <li> 
                    <a href="<?php echo $admin_url; ?>">
                        ...
                        <span class="title">Teacher Management</span>
                    </a>
                ...
                <li> 
                    <a href="<?php echo $admin_url; ?>branch/">
                ...
                <li>
                    <a href="<?php echo $admin_url; ?>">
                        ...
                        <span class="title">Semester Maangement</span>
                    </a> 
                </li>
               ...
               <li> 
                <a href="<?php echo $admin_url; ?>">
                    ...
                    <span class="title">Attendance Mangement</span>
                </a> 
            </li>
            <li> 
                <a href="<?php echo $admin_url; ?>">
                    <i class="entypo-address"></i>
                    <span class="title">Placement Mangement</span>
                </a> 
            </li>
            <li>
               <a href="<?php echo $admin_url; ?>">
                   <i class="entypo-shareable"></i>
                   <span class="title">Exam Maangement</span>
               </a> 
           </li>
           <li> 
            <a href="<?php echo $admin_url; ?>">
        ...
        <div class="col-md-6 col-sm-8 clearfix">
            <ul class="user-info pull-left pull-none-xsm">
                ...
                <li class="profile-info dropdown">
                    ...
                    <a href="<?php echo $admin_url; ?>#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo base_url(); ?>profile_pics/<?php echo $profile_pic;?>" alt="" class="img-circle" width="44" /><?php echo humanize($name); ?>
                    </a>
...
<div class="col-md-6 col-sm-4 clearfix hidden-xs">
    <ul class="list-inline links-list pull-right">
                        ...
                        <!-- <li> <a href="<?php //echo base_url(); ?>index.php/home/lock/">Lock <i class="entypo-lock right"></i> </a> </li>
                        <li class="sep"></li> -->
                        <li> <a href="<?php echo base_url(); ?>index.php/home/logout/">Log Out <i class="entypo-logout right"></i> </a> </li>
                    </ul>
                </div>
            </div>
            <hr />
