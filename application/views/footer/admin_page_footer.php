...
<link rel="stylesheet" href="<?php echo base_url();?>assets/js/fullcalendar-2/fullcalendar.min.css"  id="script-resource-14">

<script  id="script-resource-15" src="<?php echo base_url();?>assets/js/daterangepicker/moment.min.js" ></script>
<script  id="script-resource-16" src="<?php echo base_url();?>assets/js/fullcalendar-2/fullcalendar.min.js" ></script>
...
<?php }?>
<?php if($current=="verify"){?>
<script src="<?php echo base_url();?>assets/js/toastr.js" id="script-resource-18"></script>
<script  id="script-resource-17" src="<?php echo base_url();?>assets/js/jithu/admin/verify.js" ></script>
